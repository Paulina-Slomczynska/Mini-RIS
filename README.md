...
* Dodatkowe narzędzie weryfikujące jakość danych w bazie, które generuje raport z analizy w postaci pliku CSV

## Technologia
* **Język:** Python 3.x
* **Baza danych:** PostgreSQL
* **Biblioteki:** psycopg2, os, dotenv, datetime, matplotlib, pandas
